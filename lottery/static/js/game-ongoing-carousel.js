...
function setCarouselButtons(){
    let carousels = $(".slf-user-closed-games-card-slider-wrapper");
...
function resetAllSliderElements(){
    let carousels_first_els = $(".slf-user-closed-games-slider-body .slf-user-closed-games-slider-element:first-of-type");
...
function setEventListenersToButtons(){
    let listen_buttons_all = $(".slf-user-closed-games-card-slider-wrapper .slf-slider-btn");
    for (let i = 0; i < listen_buttons_all.length; i++){
        $(listen_buttons_all[i]).unbind('click');
    }

    let listen_buttons = $(".slf-user-closed-games-card-slider-wrapper .slf-btn-slider-active");
