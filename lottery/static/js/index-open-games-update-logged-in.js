function indexUpdateOpenGamesLoggedIn(lottery, card_holder, g_img, s_img, b_img){
    ...
    // Новый розыгрыш
        ...
        $(card_holder).fadeOut(300, function(){
            ...
            // Удаляем последний розыгрыш из текущих
            $(current_lotteries_cards[current_lotteries_cards.length - 1]).remove();
