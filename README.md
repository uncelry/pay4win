...
## Содержание
- [Что такое Pay4Win?](#что-такое-pay4win)
- [Как пользоваться приложением?](#как-пользоваться-приложением)
- [Какой стек технологией используется в проекте?](#какой-стек-технологией-используется-в-проекте)
- [Что такое розыгрыш?](#что-такое-розыгрыш)
- [Структура проекта](#структура-проекта)
  ...
  - [Пользовательская часть](#пользовательская-часть)
    ...
    - [Контакты](#контакты)
    - [Поиск](#поиск)
    - [Страница розыгрыша](#страница-розыгрыша)
...
## Структура проекта
<details>
<summary>Подробное описание работы проекта</summary>
